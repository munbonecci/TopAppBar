<h1 align="center">TopAppBar</h1> 

<p align="center">
This app was created to learn more about Android compose using the TopAppBar component.
</p>
...
```bash
git clone https://github.com/munbonecci/TopAppBar.git
```
